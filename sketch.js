...
function setup() {
  ...
  //creating the monkey
  monkey=createSprite(80, windowHeight-85, 20, 20);
  ...
  //creating the ground
  ground = createSprite(windowWidth/2,windowHeight-50,windowWidth+20,10);
  //ground.velocityX = -4;
...
function spawnObstacles(){
 if (frameCount % 300 === 0){
   var obstacle = createSprite(windowWidth+20,windowHeight-62,10,40);
...
function spawnbananas() {
  ...
  if (frameCount == 1) {
    banana = createSprite(windowWidth+20,windowHeight-280,40,10);
    banana.y = Math.round(random(windowHeight-340, windowHeight-200));
  ...
  if (frameCount%240 === 0) {
    banana1 = createSprite(windowWidth+20,windowHeight-280,40,10);
    banana1.y =  Math.round(random(windowHeight-340, windowHeight-200));
  ...
  if (frameCount%240 == 80) {
    banana2 = createSprite(windowWidth+20,windowHeight-280,40,10);
    banana2.y =  Math.round(random(windowHeight-340, windowHeight-200));
  ...
  if (frameCount%240 === 160) {
    banana3 = createSprite(windowWidth+20,windowHeight-280,40,10);
    banana3.y =  Math.round(random(windowHeight-340, windowHeight-200));
